      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-36 md:pt-44 pb-32 md:px-10">
        ...
        <div className="mx-auto max-w-3xl text-center mb-20">
          ...
          <p className="mt-6 text-base leading-relaxed text-white/60 md:text-lg">
            MARS operates across eight active service verticals, delivering end-to-end design, automation, engineering, and outreach solutions.
          </p>
        </div>
        ...
        {useMemo(() => (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32">
            {/* Vertical 1 */}
            <Link to="/services/web-dev" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-white/60 mb-6 font-light">
                    We design, build, and run everything a modern business needs to attract, engage, and convert customers online. We align brand identity, responsive landing pages, paid performance media, SEO, and automated CRMs.
                  </p>
                </div>
                <ul className="space-y-2 text-xs text-white/50 border-t border-white/5 pt-4">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Google/Meta Ads Performance
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Brand Identity & Styling Direction
                  </li>
                </ul>
              </BorderLaserCard>
            </Link>
            ...
            {/* Vertical 2 */}
            <Link to="/services/automation" className="block h-full cursor-pointer lg:col-span-2 transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
            ...
            {/* Vertical 3 */}
            <Link to="/services/filmmaking" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
            ...
            {/* Vertical 4 */}
            <Link to="/services/consulting" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                ...
                <ul className="space-y-2 text-xs text-white/50 border-t border-white/5 pt-4">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Embedded Execution & Management
                  </li>
                </ul>
              </BorderLaserCard>
            </Link>
            ...
            {/* Vertical 5 */}
            <Link to="/services/investment" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
            ...
            {/* Vertical 6 */}
            <Link to="/services/ai-engineering" className="block h-full cursor-pointer lg:col-span-2 transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">
                    06. Custom AI Solutions & Engineering
                  </h3>
                  <p className="text-sm leading-relaxed text-white/60 mb-6 font-light">
                    Designing bespoke large-scale AI pipelines, training custom LLMs/LoRAs, and embedding models. We go beyond out-of-the-box API wrappers to build custom Retrieval-Augmented Generation (RAG) models, secure vector databases, and private models that operate strictly on your company's data and policies.
                  </p>
                </div>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-white/50 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Custom RAG & Vector Indexes
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Fine-tuning Open LLMs & LoRAs
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Secure private data-isolated models
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Compliant AI API Gateways
                  </li>
                </ul>
              </BorderLaserCard>
            </Link>
            ...
            {/* Vertical 7 */}
            <Link to="/services/brand-design" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">
                    07. Brand Identity & Visual Systems
                  </h3>
                  <p className="text-sm leading-relaxed text-white/60 mb-6 font-light">
                    Creative visual systems, logos, packaging, campaign assets, and UI design. We build cohesive brand architectures that resonate with audiences across print, web, packaging, and video. Our creative direction merges aesthetic purity with strategic marketing.
                  </p>
                </div>
                <ul className="space-y-2 text-xs text-white/50 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Logo Systems & Visual Guidelines
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Physical Product Packaging Design
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> UI/UX Visual Layout Frameworks
                  </li>
                </ul>
              </BorderLaserCard>
            </Link>
            ...
            {/* Vertical 8 */}
            <Link to="/services/lead-gen" className="block h-full cursor-pointer lg:col-span-2 transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">
                    08. AI Lead Generation & Voice Outreach
                  </h3>
                  <p className="text-sm leading-relaxed text-white/60 mb-6 font-light">
                    Building fully autonomous AI calling agents and extracting verified business data for targeted B2B outreach. We build systems that scout, qualify, call, follow-up, and book appointments without human agents.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-white/5 pt-4 text-xs text-white/50">
                  <div>
                    <p className="font-medium text-white/80 mb-1">Target Scopes:</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> Scrapes Localized Directories</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> Verifies Contact Channels</p>
                  </div>
                  <div>
                    <p className="font-medium text-white/80 mb-1">Outbound Integrations:</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> Vobiz VOIP SIP Trunking</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> ElevenLabs Voice API</p>
                  </div>
                  <div>
                    <p className="font-medium text-white/80 mb-1">Automated Outcomes:</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> CRM Syncing & Meeting Bookings</p>
                    <p className="flex items-center gap-2"><span className="h-1 w-1 rounded-none bg-white/60" /> 350+ calls/day qualified</p>
                  </div>
                </div>
              </BorderLaserCard>
            </Link>
            ...
            {/* Vertical 9 */}
            <Link to="/services/market-analysis" className="block h-full cursor-pointer transition duration-300 hover:scale-[1.01]">
              <BorderLaserCard className="p-5 sm:p-8 flex flex-col justify-between h-full animate-crt-scan" borderRadius={isMobile ? 0 : 24}>
                <div>
                  <div className="h-12 w-12 rounded-none bg-white/5 border border-white/10 flex items-center justify-center mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">
                    09. Market Analysis & Data Intelligence
                  </h3>
                  <p className="text-sm leading-relaxed text-white/60 mb-6 font-light">
                    We perform deep-dive market audits, localized directory scraping, multi-channel lead verification, and competitor benchmarking. We extract verified business data to fuel B2B strategic planning.
                  </p>
                </div>
                <ul className="space-y-2 text-xs text-white/50 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Localized Registry Scouting
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> HLR/SMTP Multi-point Ping
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-none bg-white/40" /> Competitor Benchmarking Matrices
                  </li>
                </ul>
              </BorderLaserCard>
            </Link>
